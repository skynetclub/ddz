...
private:
	...
	void menuCallbackYi(CCObject* sender);//一分
	void menuCallbackEr(CCObject* sender);//两分
	void menuCallbackSan(CCObject* sender);//三分
	void menuCallbackBuJiao(CCObject* sender);//不叫
	void menuChuPai(CCObject* sender);//出牌
	void menuBuChu(CCObject* sender);//不出
	void menuShengLi(CCObject* sender);//胜利
	void menuShu(CCObject* sender);//失败
